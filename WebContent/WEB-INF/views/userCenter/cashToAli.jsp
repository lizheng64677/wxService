    ...
    <div class="content">
       <div class="box">
           <ul>
               ...
               <li class="alipayNameInput"><input class="input" type="text" id="name" value="${ali_user_name }" maxlength="10" readonly="readonly"></li>
           </ul>
        </div>
        <div class="box">
           <ul>
             <li class="alipayNum">支付宝账号</li>
             <li class="accountNumber"><input class="input" type="text" id="ali" value="${ali_pay }" maxlength="40" readonly="readonly"></li>
           </ul>
        </div>
        <div class="box">
           <ul>
 	...
 	$(document).ready(function(){
 		...
 		$("#a").on("click",function(){
			...
			if(p.isEmpty()){
 			...
 			post("/sen/cashToAli",{cash:m,alipay:ali,password:p,name:name},true,'提交中')
 			.then(function(data){
 		...
 		$("#IKnow").on("click",function(){
 			$(".turnOut").hide();
 			window.location.href="<c:url value='/user/toWallet'/>";
 		});		
 	});
 </script>
</body>
