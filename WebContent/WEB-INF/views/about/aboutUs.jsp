...
<div class="flMainBox">
	<ul>
    	<li ><a  style="float:left;"href="<c:url value='/about/toIntroduction'/>">
    		<img src="<c:url value='/resources/images/web/about/ptgz.png'/>">
    		<p>平台规则</p>
    		</a>
    	</li><span class="xian"></span>
        <li><a href="<c:url value='/about/toAgreement'/>">
        	<img src="<c:url value='/resources/images/web/about/yhxy.png'/>">
        	<p>用户协议</p>
        	</a>
        </li>
        <li ><a  style="float:left;border-top: 1px solid #ebebeb" href="<c:url value='/about/toCompany'/>">
        ...
        <li ><a style="border-top: 1px solid #ebebeb;" href="<c:url value='/about/toAddressList'/>">
...
<div class="phoneBox">
	<span><a href="tel:400-8540505"><input type="button" value="联系我们" class="buttons"></a></span>
</div>
</body>
</html>
